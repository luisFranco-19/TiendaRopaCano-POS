...
1. **Windows 10 o 11**.
2. **Git**: Descárgalo e instálalo desde [git-scm.com](https://git-scm.com/) si aún no lo tienes.
3. **SDK de .NET 10**: Descarga la versión correspondiente desde [dotnet.microsoft.com](https://dotnet.microsoft.com/download).
4. **Visual Studio 2022/2023** con la carga de trabajo **Desarrollo de escritorio de .NET** (opción recomendada) o en su defecto, la CLI de `dotnet` instalada.
